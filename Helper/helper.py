start_text = '''This bot is for downloading any anime direclty via links in multiple quality made with Love by ~ @Siddharth_Otaku
...
To report any Problems, Bugs, Suggestions go to @AnimaxChatZone'''
